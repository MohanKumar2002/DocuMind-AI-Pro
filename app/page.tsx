...
const FEATURES = [
  { icon: MessageSquare, title: 'Chat with any document', desc: 'Ask questions in plain language. Get cited, accurate answers from PDF, Word, TXT, CSV — powered by Google Gemini 2.5 Flash.', color: '#6c3de8' },
